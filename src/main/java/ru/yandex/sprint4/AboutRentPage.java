...
public class AboutRentPage extends BasePage {
    ...
    //private final By approveOrderButton = By.xpath(".//button[@class='Button_Button__ra12g Button_Middle__1CSJM']");
    ...
    private final By approvedOrderWindow = By.className("Order_NextButton__1_rCA");
